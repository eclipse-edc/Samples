...
public class FileTransferListenerSampleTest {
    ...
    static final String CONSUMER_CONFIG_PROPERTIES_FILE_PATH = "04.1-file-transfer-listener/file-transfer-listener-consumer/config.properties";
    static final String PROVIDER_CONFIG_PROPERTIES_FILE_PATH = "04.0-file-transfer/file-transfer-provider/config.properties";
    // Reuse an already existing file for the test. Could be set to any other existing file in the repository.
    static final String SAMPLE_ASSET_FILE_PATH = "04.1-file-transfer-listener/README.md";
    static final String DESTINATION_FILE_PATH = "04.1-file-transfer-listener/requested.test.txt";
    // marker.txt is a fixed name and always in the same directory as the file defined with DESTINATION_FILE_PATH.
    static final String MARKER_FILE_PATH = "04.1-file-transfer-listener/marker.txt";
    ...
    static EdcRuntimeExtension provider = new EdcRuntimeExtension(
            ":04.0-file-transfer:file-transfer-provider",
            "provider",
            Map.of(
    ...
    static EdcRuntimeExtension consumer = new EdcRuntimeExtension(
            ":04.1-file-transfer-listener:file-transfer-listener-consumer",
            "consumer",
            Map.of(
