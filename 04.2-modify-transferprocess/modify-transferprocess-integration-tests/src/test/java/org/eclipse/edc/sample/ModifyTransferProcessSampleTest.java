...
public class ModifyTransferProcessSampleTest {
    ...
    static final String CONSUMER_CONFIG_PROPERTIES_FILE_PATH = "04.2-modify-transferprocess/modify-transferprocess-consumer/config.properties";
    ...
    static EdcRuntimeExtension consumer = new EdcRuntimeExtension(
            ":04.2-modify-transferprocess:modify-transferprocess-consumer",
            "consumer",
            Map.of(
