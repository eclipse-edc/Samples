...
```bash
./gradlew 04.2-modify-transferprocess:modify-transferprocess-consumer:build
java -Dedc.fs.config=04.2-modify-transferprocess/modify-transferprocess-consumer/config.properties -jar 04.2-modify-transferprocess/modify-transferprocess-consumer/build/libs/consumer.jar
```
