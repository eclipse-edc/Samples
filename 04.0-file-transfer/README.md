...
```kotlin
implementation(project(":04.0-file-transfer:transfer-file-local"))
```
...
```kotlin
implementation(project(":04.0-file-transfer:status-checker"))
```
...
```bash
./gradlew 04.0-file-transfer:file-transfer-consumer:build
java -Dedc.fs.config=04.0-file-transfer/file-transfer-consumer/config.properties -jar 04.0-file-transfer/file-transfer-consumer/build/libs/consumer.jar
