...
public class FileTransferSampleTest {
    ...
    static final String CONSUMER_CONFIG_PROPERTIES_FILE_PATH = "04.0-file-transfer/file-transfer-consumer/config.properties";
    static final String PROVIDER_CONFIG_PROPERTIES_FILE_PATH = "04.0-file-transfer/file-transfer-provider/config.properties";
    static final String SAMPLE_ASSET_FILE_PATH = "04.0-file-transfer/README.md";
    static final String DESTINATION_FILE_PATH = "04.0-file-transfer/requested.test.txt";
    ...
    static EdcRuntimeExtension consumer = new EdcRuntimeExtension(
            ":04.0-file-transfer:file-transfer-consumer",
            "consumer",
            Map.of(
