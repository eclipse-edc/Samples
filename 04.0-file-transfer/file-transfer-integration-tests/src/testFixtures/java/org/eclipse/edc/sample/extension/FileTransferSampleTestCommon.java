...
public class FileTransferSampleTestCommon {
    ...
    static final String CONTRACT_OFFER_FILE_PATH = "04.0-file-transfer/contractoffer.json";
    static final String TRANSFER_FILE_PATH = "04.0-file-transfer/filetransfer.json";
     ...
     * This method corresponds to the command in the sample: {@code curl -X POST -H "Content-Type: application/json" -H "X-Api-Key: password" -d @04.0-file-transfer/contractoffer.json "http://localhost:9192/api/v1/management/contractnegotiations"}
     */
     ...
     * This method corresponds to the command in the sample: {@code curl -X POST -H "Content-Type: application/json" -H "X-Api-Key: password" -d @04.0-file-transfer/filetransfer.json "http://localhost:9192/api/v1/management/transferprocess"}
     *
