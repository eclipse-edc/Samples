...
public class FileTransferListenerSampleTest {
    ...
    static final String SAMPLE_ASSET_FILE_PATH = "transfer/transfer-02-file-transfer-listener/README.md";
    static final String DESTINATION_FILE_PATH = "transfer/transfer-02-file-transfer-listener/requested.test.txt";
    // marker.txt is a fixed name and always in the same directory as the file defined with DESTINATION_FILE_PATH.
    static final String MARKER_FILE_PATH = "transfer/transfer-02-file-transfer-listener/marker.txt";
