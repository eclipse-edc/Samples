...
```bash
./gradlew clean build
java -Dedc.fs.config=05-file-transfer-cloud/cloud-transfer-consumer/config.properties -jar 05-file-transfer-cloud/cloud-transfer-consumer/build/libs/consumer.jar
# in another terminal window:
java -Dedc.fs.config=05-file-transfer-cloud/cloud-transfer-provider/config.properties -jar 05-file-transfer-cloud/cloud-transfer-provider/build/libs/provider.jar
```
