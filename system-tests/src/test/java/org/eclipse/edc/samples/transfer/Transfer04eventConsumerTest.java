...
public class Transfer04eventConsumerTest {
    ...
    static final String CONSUMER_CONFIG_PROPERTIES_FILE_PATH = "transfer/transfer-04-file-transfer-listener/file-transfer-listener-consumer/config.properties";
    static final String PROVIDER_CONFIG_PROPERTIES_FILE_PATH = "transfer/transfer-04-file-transfer/file-transfer-provider/config.properties";
    // Reuse an already existing file for the test. Could be set to any other existing file in the repository.
    static final String SAMPLE_ASSET_FILE_PATH = "transfer/transfer-04-file-transfer-listener/README.md";
    static final String DESTINATION_FILE_PATH = "transfer/transfer-04-file-transfer-listener/requested.test.txt";
    // marker.txt is a fixed name and always in the same directory as the file defined with DESTINATION_FILE_PATH.
    static final String MARKER_FILE_PATH = "transfer/transfer-04-file-transfer-listener/marker.txt";
    ...
    static EdcRuntimeExtension consumer = new EdcRuntimeExtension(
            ":transfer:transfer-04-file-transfer-listener:file-transfer-listener-consumer",
            "consumer",
            Map.of(
                    "edc.fs.config", getFileFromRelativePath(CONSUMER_CONFIG_PROPERTIES_FILE_PATH).getAbsolutePath()
            )
    );
    private final FileTransferCommon common = new FileTransferCommon(SAMPLE_ASSET_FILE_PATH, DESTINATION_FILE_PATH);
